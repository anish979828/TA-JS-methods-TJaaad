...
function addTwoToArray(array){
  ...
  for (let i = 0; i < array.length; i++){
    arr.push(addTwo(array[i]));
  }
  return arr;
}
console.log(addTwoToArray([9 , 2, 3]));
...
function addThreeToArray(array){
  let arr = [];
  for (let i = 0; i < array.length; i++){
    arr.push(addThree(array[i]));
  }
  return arr;
}
console.log(addThreeToArray([9 , 2, 3]));
...
function addFiveToArray(array){
  let arr = [];
  for(let i = 0; i < array.length; i++){
    arr.push(addFive(array[i]));
  }
  return arr;
}
console.log(addFiveToArray([9 , 2, 3]));
...
console.log(isFemale(grades[0])); // true
console.log(isFemale(grades[1])); // false
console.log(isFemale(grades[2])); // true
